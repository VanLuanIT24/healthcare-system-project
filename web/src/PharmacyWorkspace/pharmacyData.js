...
export const pharmacyMenuSections = [
  ...
  },
  {
    ...
    defaultOpen: false,
    children: [
      { id: 'transactions-center', label: 'Trung tâm giao dịch kho', to: '/pharmacy/transactions/center', icon: ArrowLeftRight },
  ...
  },
  {
    ...
    defaultOpen: false,
    children: [
      { id: 'reports-dashboard', label: 'Dashboard báo cáo dược', to: '/pharmacy/reports/dashboard', icon: BarChart3 },
      ...
      { id: 'reports-export-history', label: 'Xuất báo cáo / lịch sử export', to: '/pharmacy/reports/export-history', icon: FileCheck2 },
    ],
  },
  {
    id: 'alerts',
    ...
    children: [
      ...
      { id: 'alerts-insufficient', label: 'Không đủ thuốc cấp phát', to: '/pharmacy/alerts/dispense-shortage', icon: ClipboardList },
      ...
      { id: 'alerts-loss-waste', label: 'Hao hụt / hủy thuốc', to: '/pharmacy/alerts/waste-loss', icon: RotateCcw },
    ],
  },
  {
    id: 'settings',
    ...
    defaultOpen: false,
    children: [
      { id: 'config-overview', label: 'Tổng quan cấu hình', to: '/pharmacy/config', icon: Settings },
      { id: 'config-medication-units', label: 'Đơn vị thuốc', to: '/pharmacy/config/units', icon: Pill },
      { id: 'config-dosage-forms', label: 'Dạng bào chế', to: '/pharmacy/config/dosage-forms', icon: FileText },
      { id: 'config-administration-routes', label: 'Đường dùng', to: '/pharmacy/config/routes', icon: Activity },
      { id: 'config-storage-locations', label: 'Vị trí lưu kho', to: '/pharmacy/config/storage-locations', icon: Boxes },
      { id: 'config-suppliers', label: 'Nhà cung cấp', to: '/pharmacy/config/suppliers', icon: PackagePlus },
      { id: 'config-alert-thresholds', label: 'Ngưỡng cảnh báo', to: '/pharmacy/config/alert-thresholds', icon: Bell },
      { id: 'config-expiry-policy', label: 'Chính sách FEFO / expiry', to: '/pharmacy/config/expiry-policies', icon: TimerOff },
      { id: 'config-controlled-medications', label: 'Chính sách thuốc kiểm soát', to: '/pharmacy/config/controlled-drugs', icon: ShieldAlert },
    ],
  },
];
