...
export const labMenuSections = [
  ...
  },
  {
    ...
    defaultOpen: false,
    children: [
      menuItem('charge-dashboard', 'Tổng quan charge CLS', '/lab/charges/dashboard', WalletCards, [LAB_TECHNICIAN, LAB_MANAGER, IMAGING_TECHNICIAN, RADIOLOGIST, PROCEDURE_STAFF, DOCTOR]),
      menuItem('charge-action-queue', 'Charge cần xử lý', '/lab/charges/action-queue', AlertTriangle, [LAB_TECHNICIAN, LAB_MANAGER, IMAGING_TECHNICIAN, PROCEDURE_STAFF]),
      menuItem('charge-missing', 'Chờ tạo charge', '/lab/charges/missing', Clock3, [LAB_TECHNICIAN, LAB_MANAGER, IMAGING_TECHNICIAN, PROCEDURE_STAFF]),
      menuItem('charge-by-order', 'Charge theo order', '/lab/charges/by-order', History, [LAB_TECHNICIAN, LAB_MANAGER, IMAGING_TECHNICIAN, PROCEDURE_STAFF, DOCTOR]),
      menuItem('charge-lab', 'Charge xét nghiệm', '/lab/charges/lab', FlaskConical, [LAB_TECHNICIAN, LAB_MANAGER]),
      menuItem('charge-imaging', 'Charge chẩn đoán hình ảnh', '/lab/charges/imaging', ScanLine, [IMAGING_TECHNICIAN, RADIOLOGIST, LAB_MANAGER]),
      menuItem('charge-procedure', 'Charge thủ thuật', '/lab/charges/procedure', ClipboardPlus, [PROCEDURE_STAFF, LAB_MANAGER]),
      menuItem('charge-posted', 'Charge đã post', '/lab/charges/posted', CheckCircle2, [LAB_MANAGER, PROCEDURE_STAFF]),
      menuItem('charge-unbilled', 'Charge chưa lên hóa đơn', '/lab/charges/unbilled', ClipboardList, [LAB_MANAGER, PROCEDURE_STAFF]),
      menuItem('charge-billed', 'Charge đã lên hóa đơn', '/lab/charges/billed', BadgeCheck, [LAB_MANAGER, PROCEDURE_STAFF]),
      menuItem('charge-exceptions', 'Charge lỗi / cần review', '/lab/charges/exceptions', ShieldAlert, [LAB_MANAGER, PROCEDURE_STAFF]),
      menuItem('charge-reconciliation', 'Đối soát charge với Billing', '/lab/charges/reconciliation', ClipboardCheck, [LAB_MANAGER, PROCEDURE_STAFF]),
    ],
  },
  {
    id: 'clinical-payment',
    ...
    defaultOpen: false,
    children: [
      menuItem('payment-dashboard', 'Tổng quan payment CLS', '/lab/payments/dashboard', WalletCards, [LAB_TECHNICIAN, LAB_MANAGER, IMAGING_TECHNICIAN, RADIOLOGIST, PROCEDURE_STAFF, DOCTOR]),
      menuItem('payment-waiting', 'Chờ thanh toán trước thực hiện', '/lab/payments/waiting-payment', Clock3, [LAB_TECHNICIAN, LAB_MANAGER, IMAGING_TECHNICIAN, PROCEDURE_STAFF]),
      menuItem('payment-ready', 'Đã thanh toán / sẵn sàng thực hiện', '/lab/payments/ready-to-perform', BadgeCheck, [LAB_TECHNICIAN, LAB_MANAGER, IMAGING_TECHNICIAN, PROCEDURE_STAFF]),
      menuItem('payment-confirmation', 'Chờ xác nhận QR / chuyển khoản', '/lab/payments/waiting-confirmation', ClipboardCheck, [LAB_MANAGER, PROCEDURE_STAFF]),
      menuItem('payment-manual-review', 'Manual review payment', '/lab/payments/manual-review', ShieldAlert, [LAB_MANAGER, PROCEDURE_STAFF]),
      menuItem('payment-encounter', 'Payment theo encounter', '/lab/payments/by-encounter', ClipboardList, [LAB_MANAGER, PROCEDURE_STAFF, DOCTOR]),
      menuItem('payment-order', 'Payment theo order dịch vụ', '/lab/payments/by-order', History, [LAB_TECHNICIAN, LAB_MANAGER, IMAGING_TECHNICIAN, PROCEDURE_STAFF, DOCTOR]),
      menuItem('payment-errors', 'Payment lỗi / hết hạn / bị từ chối', '/lab/payments/errors', AlertTriangle, [LAB_MANAGER, PROCEDURE_STAFF]),
      menuItem('payment-refund-void', 'Refund / void liên quan CLS', '/lab/payments/refund-void', AlertTriangle, [LAB_MANAGER, PROCEDURE_STAFF]),
    ],
  },
  {
    id: 'clinical-billing',
    ...
    defaultOpen: false,
    children: [
      menuItem('billing-dashboard', 'Tổng quan hóa đơn CLS', '/lab/billing/dashboard', WalletCards, [LAB_TECHNICIAN, LAB_MANAGER, IMAGING_TECHNICIAN, RADIOLOGIST, PROCEDURE_STAFF, DOCTOR]),
      menuItem('billing-charge-candidates', 'Chờ tạo charge', '/lab/billing/charge-candidates', Clock3, [LAB_TECHNICIAN, LAB_MANAGER, IMAGING_TECHNICIAN, PROCEDURE_STAFF]),
      menuItem('billing-charges', 'Charge cận lâm sàng', '/lab/billing/charges', WalletCards, [LAB_TECHNICIAN, LAB_MANAGER, IMAGING_TECHNICIAN, PROCEDURE_STAFF]),
      menuItem('billing-unbilled', 'Chờ lập hóa đơn', '/lab/billing/unbilled-charges', ClipboardList, [LAB_MANAGER, PROCEDURE_STAFF]),
      menuItem('billing-draft', 'Hóa đơn nháp', '/lab/billing/invoices/draft', FileText, [LAB_MANAGER, PROCEDURE_STAFF]),
      menuItem('billing-issued', 'Hóa đơn đã phát hành', '/lab/billing/invoices/issued', FileCheck2, [LAB_MANAGER, PROCEDURE_STAFF]),
      menuItem('billing-unpaid', 'Hóa đơn chưa thanh toán', '/lab/billing/invoices/unpaid', AlertTriangle, [LAB_MANAGER, PROCEDURE_STAFF]),
      menuItem('billing-partial', 'Thanh toán một phần', '/lab/billing/invoices/partial', Clock3, [LAB_MANAGER, PROCEDURE_STAFF]),
      menuItem('billing-paid', 'Hóa đơn đã thanh toán', '/lab/billing/invoices/paid', BadgeCheck, [LAB_MANAGER, PROCEDURE_STAFF]),
      menuItem('billing-exceptions', 'Lỗi nghiệp vụ billing', '/lab/billing/exceptions', ShieldAlert, [LAB_MANAGER, PROCEDURE_STAFF]),
      menuItem('billing-encounter', 'Theo encounter', '/lab/billing/by-encounter', ClipboardList, [LAB_MANAGER, PROCEDURE_STAFF, DOCTOR]),
      menuItem('billing-order', 'Theo order', '/lab/billing/by-order', History, [LAB_TECHNICIAN, LAB_MANAGER, IMAGING_TECHNICIAN, PROCEDURE_STAFF, DOCTOR]),
      menuItem('billing-patient', 'Theo bệnh nhân', '/lab/billing/by-patient', Users, [LAB_MANAGER, PROCEDURE_STAFF, DOCTOR]),
      menuItem('billing-reconciliation', 'Đối soát order-charge-invoice', '/lab/billing/reconciliation', ClipboardCheck, [LAB_MANAGER, PROCEDURE_STAFF]),
      menuItem('billing-adjustments', 'Điều chỉnh / void hóa đơn', '/lab/billing/adjustments', AlertTriangle, [LAB_MANAGER, PROCEDURE_STAFF]),
    ],
  },
  {
    id: 'approvals',
