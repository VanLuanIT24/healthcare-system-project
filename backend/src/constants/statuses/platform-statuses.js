...
const REALTIME_EVENT_TYPE = {
  ...
  PAYMENT_INTENT_REJECTED: 'payment_intent.rejected',
  ...
  REFUND_EVIDENCE_REQUIRED: 'refund.evidence_required',
  ...
  BILLING_RECONCILIATION_MISMATCH: 'billing.reconciliation.mismatch',
  RECEIPT_GENERATED: 'receipt.generated',
  LAB_ORDER_CREATED: 'lab_order.created',
  LAB_ORDER_ACKNOWLEDGED: 'lab_order.acknowledged',
  LAB_ORDER_STARTED: 'lab_order.started',
  LAB_ORDER_COMPLETED: 'lab_order.completed',
  LAB_ORDER_CANCELLED: 'lab_order.cancelled',
  LAB_SAMPLE_COLLECTED: 'lab_sample_collected',
  SPECIMEN_CREATED: 'specimen.created',
  SPECIMEN_COLLECTED: 'specimen.collected',
  SPECIMEN_RECEIVED: 'specimen.received',
  SPECIMEN_REJECTED: 'specimen.rejected',
  SPECIMEN_IN_TESTING: 'specimen.in_testing',
  LAB_RESULT_READY: 'lab_result_ready',
  LAB_RESULT_RELEASED: 'lab_result_released',
  LAB_RESULT_CREATED: 'lab_result.created',
  LAB_RESULT_FINALIZED: 'lab_result.finalized',
  LAB_RESULT_AMENDED: 'lab_result.amended',
  LAB_RESULT_CRITICAL: 'lab_result.critical',
  LAB_RESULT_CRITICAL_ACKNOWLEDGED: 'lab_result.critical_acknowledged',
  LAB_CRITICAL_VALUE: 'lab_critical_value',
  IMAGING_ORDER_CREATED: 'imaging_order_created',
  IMAGING_ORDER_SCHEDULED: 'imaging_order.scheduled',
  IMAGING_ORDER_STARTED: 'imaging_order.started',
  IMAGING_ORDER_COMPLETED: 'imaging_order.completed',
  IMAGING_ORDER_NO_SHOW: 'imaging_order.no_show',
  IMAGING_REPORT_READY: 'imaging_report_ready',
  IMAGING_REPORT_RELEASED: 'imaging_report_released',
  IMAGING_REPORT_CREATED: 'imaging_report.created',
  IMAGING_REPORT_FINALIZED: 'imaging_report.finalized',
  IMAGING_REPORT_AMENDED: 'imaging_report.amended',
  IMAGING_REPORT_CRITICAL: 'imaging_report.critical',
  IMAGING_REPORT_CRITICAL_ACKNOWLEDGED: 'imaging_report.critical_acknowledged',
  IMAGING_CRITICAL_FINDING: 'imaging_critical_finding',
  PROCEDURE_ORDER_SCHEDULED: 'procedure_order.scheduled',
  PROCEDURE_ORDER_STARTED: 'procedure_order.started',
  ...
  PROCEDURE_CHARGE_CREATED: 'procedure_charge.created',
  CLINICAL_OPS_WORKLIST_UPDATED: 'clinical_ops.worklist.updated',
  CLINICAL_OPS_SAFETY_SUMMARY_UPDATED: 'clinical_ops.safety_summary.updated',
  CLINICAL_OPS_SLA_BREACHED: 'clinical_ops.sla_breached',
  CLINICAL_OPS_ESCALATION_CREATED: 'clinical_ops.escalation.created',
  ...
  VITAL_SIGN_RECORDED: 'vital_sign.recorded',
  VITAL_SIGN_ABNORMAL: 'vital_sign.abnormal',
  VITAL_SIGN_CRITICAL: 'vital_sign.critical',
  TRIAGE_COMPLETED: 'triage.completed',
  NURSING_ALERT_CREATED: 'nursing_alert.created',
  NURSING_ALERT_RESOLVED: 'nursing_alert.resolved',
  ...
  INVENTORY_TRANSACTION_CREATED: 'inventory.transaction_created',
  PRESCRIPTION_CREATED: 'prescription.created',
  PRESCRIPTION_VERIFIED: 'prescription.verified',
  PRESCRIPTION_REJECTED: 'prescription.rejected',
  PRESCRIPTION_HELD: 'prescription.held',
  PRESCRIPTION_READY_FOR_DISPENSE: 'prescription.ready_for_dispense',
  DISPENSE_CREATED: 'dispense.created',
  DISPENSE_ITEM_DISPENSED: 'dispense.item_dispensed',
  DISPENSE_PARTIALLY_DISPENSED: 'dispense.partially_dispensed',
  DISPENSE_COMPLETED: 'dispense.completed',
  DISPENSE_RETURNED: 'dispense.returned',
  DISPENSE_CANCELLED: 'dispense.cancelled',
  PHARMACY_REFILL_REQUESTED: 'pharmacy.refill_requested',
  PHARMACY_REFILL_APPROVED: 'pharmacy.refill_approved',
  PHARMACY_REFILL_REJECTED: 'pharmacy.refill_rejected',
  DRUG_SAFETY_ALLERGY_WARNING: 'drug_safety.allergy_warning',
  DRUG_SAFETY_INTERACTION_WARNING: 'drug_safety.interaction_warning',
  DRUG_SAFETY_DUPLICATE_THERAPY_WARNING: 'drug_safety.duplicate_therapy_warning',
