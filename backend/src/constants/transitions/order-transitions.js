...
const PROCEDURE_RESULT_TRANSITIONS = {
  [PROCEDURE_RESULT_STATUS.DRAFT]: [
    PROCEDURE_RESULT_STATUS.PRELIMINARY,
    PROCEDURE_RESULT_STATUS.FINAL,
    PROCEDURE_RESULT_STATUS.CANCELLED,
  ],
  [PROCEDURE_RESULT_STATUS.PRELIMINARY]: [
    PROCEDURE_RESULT_STATUS.FINAL,
    PROCEDURE_RESULT_STATUS.CANCELLED,
  ],
  [PROCEDURE_RESULT_STATUS.FINAL]: [PROCEDURE_RESULT_STATUS.AMENDED],
