...
async function quickCheckin(payload = {}, actor = {}, requestMeta = {}) {
  ...
  return {
    ...
    print_payload: payload.print_ticket === true && queueTicket?.queue_ticket
      ? {
        type: 'queue_ticket',
        queue_ticket_id: queueTicket.queue_ticket.queue_ticket_id,
        queue_number: queueTicket.queue_ticket.queue_number,
      }
      : null,
...
async function walkInCheckin(payload = {}, actor = {}, requestMeta = {}) {
  ...
  let encounter = null;
  const ticketId = queueTicket?.queue_ticket?.queue_ticket_id || queueTicket?.queue_ticket_id;
  ...
  return {
    ...
    print_payload: payload.print_ticket === true && queueTicket?.queue_ticket
      ...
      : null,
    next_step: encounter ? 'send_to_doctor' : 'send_to_nursing',
  };
}
