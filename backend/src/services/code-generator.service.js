...
const CODE_TYPE = {
  ...
  INVOICE: 'INVOICE',
  PAYMENT: 'PAYMENT',
  SERVICE_PRICE_VERSION: 'SERVICE_PRICE_VERSION',
...
const CODE_PREFIX = {
  ...
  [CODE_TYPE.PROCEDURE_RESULT]: 'PRR',
  ...
  [CODE_TYPE.SERVICE_PRICE_VERSION]: 'SPV',
  [CODE_TYPE.PAYMENT_REFUND]: 'RF',
  [CODE_TYPE.RECONCILIATION_BATCH]: 'RCB',
  [CODE_TYPE.RECONCILIATION_RULE]: 'RCR',
  [CODE_TYPE.RECONCILIATION_EXCEPTION]: 'RCX',
  [CODE_TYPE.SETTLEMENT_BATCH]: 'STL',
