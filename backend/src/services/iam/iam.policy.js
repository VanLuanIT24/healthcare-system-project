...
const PATIENT_ACCOUNT_ROLE_CODES = new Set([
  ROLE_CODE.PATIENT,
...
function assertCanAssignRole(role, actor = {}) {
  if (PATIENT_ACCOUNT_ROLE_CODES.has(role.role_code)) {
...
module.exports = {
  ...
  // PATIENT_ACCOUNT_ROLE_CODES: Role chỉ dành cho tài khoản cổng bệnh nhân, không gán cho staff.
  PATIENT_ACCOUNT_ROLE_CODES,
