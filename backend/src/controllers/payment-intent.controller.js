...
module.exports = {
  ...
  confirmManualPayment: wrap((req) => paymentIntentService.confirmManualPayment(req.params.paymentId, req.body, req.auth, requestMeta(req)), 'Xác nhận payment manual thành công.'),
  rejectManualPayment: wrap((req) => paymentIntentService.rejectManualPayment(req.params.paymentId, req.body, req.auth, requestMeta(req)), 'Từ chối payment manual thành công.'),
  refundManualPayment: wrap((req) => paymentIntentService.refundManualPayment(req.params.paymentId, req.body, req.auth, requestMeta(req)), 'Ghi nhận hoàn tiền thủ công thành công.'),
