...
module.exports = {
  ...
  listAppointments: wrap((req) => appointmentService.listAppointments(req.query, req.auth), 'Lấy danh sách lịch hẹn thành công.'),
  searchAppointments: wrap((req) => appointmentService.searchAppointments(req.query, req.auth), 'Tìm kiếm lịch hẹn thành công.'),
  getAppointmentSummary: wrap((req) => appointmentService.getAppointmentSummary(req.query, req.auth), 'Lấy thống kê lịch hẹn thành công.'),
  getAppointmentTimeline: wrap((req) => appointmentService.getAppointmentTimeline(req.params.appointmentId, req.query, req.auth), 'Lấy timeline lịch hẹn thành công.'),
  getAppointmentDetail: wrap((req) => appointmentService.getAppointmentDetail(req.params.appointmentId, req.auth), 'Lấy chi tiết lịch hẹn thành công.'),
  validateAppointmentSlot: wrap((req) => appointmentService.validateAppointmentSlot(req.body, req.auth), 'Kiểm tra slot lịch hẹn thành công.'),
  checkDoctorAvailability: wrap((req) => appointmentService.checkDoctorAvailability(req.body, req.auth), 'Kiểm tra lịch khả dụng của bác sĩ thành công.'),
  checkPatientDuplicateBooking: wrap((req) => appointmentService.checkPatientDuplicateBooking(req.body, req.auth), 'Kiểm tra đặt lịch trùng của bệnh nhân thành công.'),
  ...
  checkAppointmentConflictForDoctor: wrap((req) => appointmentService.checkAppointmentConflictForDoctor(req.body, req.auth), 'Kiểm tra xung đột lịch phía bác sĩ thành công.'),
  ...
  listAppointmentsByPatient: wrap((req) => appointmentService.listAppointmentsByPatient(req.params.patientId, req.query, req.auth), 'Lấy lịch hẹn theo bệnh nhân thành công.'),
  listAppointmentsByDoctor: wrap((req) => appointmentService.listAppointmentsByDoctor(req.params.doctorId, req.query, req.auth), 'Lấy lịch hẹn theo bác sĩ thành công.'),
  listAppointmentsByDepartment: wrap((req) => appointmentService.listAppointmentsByDepartment(req.params.departmentId, req.query, req.auth), 'Lấy lịch hẹn theo department thành công.'),
  listAppointmentsByDate: wrap((req) => appointmentService.listAppointmentsByDate(req.query.date, req.query, req.auth), 'Lấy lịch hẹn theo ngày thành công.'),
  listUpcomingAppointments: wrap((req) => appointmentService.listUpcomingAppointments(req.query, req.auth), 'Lấy lịch hẹn sắp tới thành công.'),
  listTodayAppointments: wrap((req) => appointmentService.listTodayAppointments(req.query, req.auth), 'Lấy lịch hẹn hôm nay thành công.'),
  getMyAppointments: wrap((req) => appointmentService.getMyAppointments(req.auth, req.query), 'Lấy lịch hẹn của tôi thành công.'),
  getMyAppointmentSummary: wrap((req) => appointmentService.getMyAppointmentSummary(req.auth, req.query), 'Lấy thống kê lịch hẹn của tôi thành công.'),
  getMyAppointmentTimeline: wrap((req) => appointmentService.getMyAppointmentTimeline(req.params.appointmentId, req.query, req.auth), 'Lấy timeline lịch hẹn của tôi thành công.'),
  getMyAppointmentActions: wrap((req) => appointmentService.getMyAppointmentActions(req.params.appointmentId, req.auth), 'Lấy thao tác lịch hẹn của tôi thành công.'),
  checkAppointmentCanBeUpdated: wrap((req) => appointmentService.checkAppointmentCanBeUpdated(req.params.appointmentId, req.query), 'Kiểm tra khả năng cập nhật lịch hẹn thành công.'),
