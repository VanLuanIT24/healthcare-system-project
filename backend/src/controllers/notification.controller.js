...
module.exports = {
  ...
  getMyNotificationPreferences: wrap((req) => notificationService.getMyNotificationPreferences(req.auth), 'Lấy cấu hình notification thành công.'),
  updateMyNotificationPreferences: wrap((req) => notificationService.updateMyNotificationPreferences(req.body, req.auth), 'Cập nhật cấu hình notification thành công.'),
