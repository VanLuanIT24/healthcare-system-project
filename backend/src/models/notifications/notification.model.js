...
const notificationSchema = new Schema(
  {
    ...
    recipient_actor_type: { type: String, trim: true },
    recipient_actor_id: { type: Schema.Types.Mixed },
...
notificationSchema.index({ event_type: 1 });
...
notificationSchema.index({ recipient_actor_type: 1, recipient_actor_id: 1, status: 1, created_at: -1 });
