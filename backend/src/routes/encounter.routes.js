...
router.post('/', authorize({ permissions: [PERMISSION.ENCOUNTERS.CREATE] }), encounterController.createEncounter);
...
router.post('/appointment/:appointmentId', authorize({ anyPermissions: [PERMISSION.ENCOUNTERS.CREATE_FROM_CHECKIN, PERMISSION.ENCOUNTERS.CREATE, PERMISSION.APPOINTMENTS.CHECKIN] }), encounterController.createEncounterFromAppointment);
router.post('/queue/:ticketId', authorize({ anyPermissions: [PERMISSION.ENCOUNTERS.CREATE_FROM_CHECKIN, PERMISSION.ENCOUNTERS.CREATE, PERMISSION.QUEUE.START_SERVICE] }), encounterController.createEncounterFromQueueTicket);
...
router.post('/:encounterId/orders', authorize({ anyPermissions: [PERMISSION.ORDERS.CREATE, PERMISSION.ORDERS.CREATE_LAB, PERMISSION.ORDERS.CREATE_IMAGING, PERMISSION.ORDERS.CREATE_PROCEDURE, PERMISSION.ORDERS.CREATE_MEDICATION, PERMISSION.ORDERS.CREATE_SERVICE, PERMISSION.PRESCRIPTIONS.CREATE] }), orderController.createOrderFromEncounter);
